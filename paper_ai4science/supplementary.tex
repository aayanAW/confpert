% ConfPert: Supplementary Material -- ICML 2026 AI4Research Workshop submission.
% Companion to main_paper.tex; contains all appendix sections (A-K).
% ICML 2026 style (double blind); single-column appendix layout.
...
\icmltitlerunning{ConfPert: Supplementary Material}

\begin{document}

\twocolumn[
\icmltitle{Supplementary Material for: \\ ConfPert: Distribution-Free Conformal Coverage \\ for Single-Cell Perturbation Predictors}
